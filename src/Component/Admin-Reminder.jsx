...
const AdminReminders = () => {
  ...
  const fetchReminders = async () => {
    try {
      const res = await axios.get("http://localhost:8080/api/admin/reminders");
  ...
  const handleAddReminder = async () => {
    try {
      await axios.post("http://localhost:8080/api/admin/reminders", newReminder);
      setNewReminder({
        plantId: "",
        userId: "",
        type: "",
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:8080/api/admin/reminders/${id}`);
      fetchReminders();
    } catch (err) {
